...
namespace UI.WPF.Modules.Installation.ViewModels
{
    ...
    public sealed class OldInstallationTabViewModel : Screen, ILauncherTab, IEnableLogger
    {
        ...
        public OldInstallationTabViewModel([NotNull] IRemoteModManager remoteManager,
        ...
        {
            get { return ModGroupViewModels == null ? null : ModGroupViewModels.Where(x => x.CurrentMod != null).Select(x => x.CurrentMod); }
        }
