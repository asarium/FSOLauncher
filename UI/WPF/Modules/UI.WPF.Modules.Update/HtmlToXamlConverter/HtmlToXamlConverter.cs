...
namespace HtmlToXamlConvert
{
    ...
    internal static class HtmlCssParser
    {
        ...
        private static bool ParseCssRectangleProperty(string styleValue, ref int nextIndex, Hashtable localProperties, string propertyName)
        {
            ...
            Debug.Assert(propertyName == "margin" || propertyName == "padding" || propertyName == "border-width" || propertyName == "border-style" ||
        ...
        public void DiscoverStyleDefinitions(XmlElement htmlElement)
        {
            ...
            while (nextCharacterIndex < stylesheetBuffer.Length)
            {
                ...
                if (nextCharacterIndex < stylesheetBuffer.Length)
                {
                    ...
                    {
                        this.AddStyleDefinition(stylesheetBuffer.ToString(selectorStart, definitionStart - selectorStart),
    ...
    internal class HtmlLexicalAnalyzer
    {
        ...
        internal void GetNextAtomToken()
        {
            ...
            {
                var startingQuote = this.NextCharacter;
                this.GetNextCharacter();
        ...
        private bool IsGoodForName(char character)
        {
            ...
            return this.IsGoodForNameStart(character) || character == '.' || character == '-' || character == ':' || Char.IsDigit(character) ||
                   IsCombiningCharacter(character) || IsExtender(character);
        }
    ...
    internal class HtmlParser
    {
        ...
        private XmlElement ParseHtmlContent()
        {
            ...
            if (htmlRootElement.FirstChild is XmlElement && htmlRootElement.FirstChild == htmlRootElement.LastChild &&
    ...
    public static class HtmlToXamlConverter
    {
        ...
        private static void AddBreak(XmlElement xamlParentElement, string htmlElementName)
        {
            ...
            var xamlLineBreak = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/null, /*localName:*/Xaml_LineBreak, _xamlNamespace);
            ...
            List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                var xamlElement = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/null, /*localName:*/Xaml_Section, _xamlNamespace);
            ...
            List<XmlElement> sourceContext)
        {
            ...
            // Create a XAML element corresponding to this html element
            var xamlElement = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/null, /*localName:*/Xaml_Paragraph, _xamlNamespace);
            ApplyLocalProperties(xamlElement, localProperties, /*isBlock:*/true);
            ...
            List<XmlElement> sourceContext)
        {
            ...
            var xamlParagraph = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/null, /*localName:*/Xaml_Paragraph, _xamlNamespace);
            ...
            List<XmlElement> sourceContext)
        {
            ...
            for (var htmlNode = htmlElement.FirstChild; htmlNode != null; htmlNode = htmlNode.NextSibling)
            {
                ...
                {
                    var htmlChildName = ((XmlElement) htmlNode).LocalName.ToLower();
                    if (HtmlSchema.IsInlineElement(htmlChildName) || HtmlSchema.IsBlockElement(htmlChildName) || htmlChildName == "img" ||
                        htmlChildName == "br" || htmlChildName == "hr")
                    {
            ...
            List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                // Create a XAML element corresponding to this html element
                var xamlElement = xamlParentElement.OwnerDocument.CreateElement( /*prefix:*/null, /*localName:*/Xaml_Hyperlink, _xamlNamespace);
                ApplyLocalProperties(xamlElement, localProperties, /*isBlock:*/false);
